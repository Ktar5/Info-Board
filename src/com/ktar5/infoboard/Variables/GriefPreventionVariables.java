...
public class GriefPreventionVariables {
	...
	public static String replaceVariables(String string, Player player) {
		...
		if (newString.contains("<" + prefix + "claims>"))
			newString = newString.replaceAll("<" + prefix + "claims>",
					String.valueOf(pd.claims.size()));
		if (newString.contains("<" + prefix + "spamcount>"))
			newString = newString.replaceAll("<" + prefix + "spamcount>",
					String.valueOf(pd.spamCount));
		if (newString.contains("<" + prefix + "bonusclaims>"))
			newString = newString.replaceAll("<" + prefix + "bonusclaims>",
					String.valueOf(pd.bonusClaimBlocks));
		if (newString.contains("<" + prefix + "accruedclaims>"))
			newString = newString.replaceAll("<" + prefix + "accruedclaims>",
					String.valueOf(pd.accruedClaimBlocks));
