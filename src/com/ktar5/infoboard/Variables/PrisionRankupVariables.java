		...
		if (newString.contains("<" + prefix + "nextrank>"))
			newString = newString
					.replaceAll("<" + prefix + "nextrank>", PrisonRankup
							.getNextRank(name).getName() != null ? PrisonRankup
							.getNextRank(name).getName() : "None");
		if (newString.contains("<" + prefix + "rankprice>"))
			newString = newString.replaceAll("<" + prefix + "rankprice>",
					PrisonRankup.getNextRank(name) != null ? PrisonRankup
							.getNextRank(name).getPriceString() : "0");
