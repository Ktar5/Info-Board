...
public class StatsVariables {
	...
	private static StatData getStatsData(String player, World world, String stat) {
		RegisteredServiceProvider<StatsAPI> stats = Bukkit.getServer()
				.getServicesManager()
				.getRegistration(nl.lolmewn.stats.api.StatsAPI.class);
		StatsAPI statsAPI = stats.getProvider();

		if (statsAPI.isUsingBetaFunctions())
			return statsAPI.getPlayer(player).getStatData(
					statsAPI.getStat(stat), world.getName(), true);
		else
			return statsAPI.getPlayer(player).getStatData(
					statsAPI.getStat(stat), world.getName(), true);
	}
	...
	public static String replaceVariables(String string, Player player) {
		...
		if (newString.contains("<statstime>")) {
			...
			newString = newString.replaceAll("<statstime>",
		...
		if (newString.contains("<statstimeformated>")) {
			...
			newString = newString.replaceAll("<statstime>",
					String.valueOf(Time.getFormatTime((long) value)));
		}
		if (newString.contains("<statsmoves>")) {
			...
			newString = newString.replaceAll("<statsmoves>",
					String.valueOf(value));
		}
		if (newString.contains("<statsarrows>")) {
			...
			newString = newString.replaceAll("<statsarrows>",
					String.valueOf(value));
		}
		if (newString.contains("<statsjoins>")) {
			...
			newString = newString.replaceAll("<statsjoins>",
					String.valueOf(value));
		}
		if (newString.contains("<statsfish>")) {
			...
			newString = newString.replaceAll("<statsfish>",
					String.valueOf(value));
		}
		if (newString.contains("<statsdamagetaken>")) {
			...
			newString = newString.replaceAll("<statsdamagetaken>",
					String.valueOf(value));
		}
		if (newString.contains("<statskicked>")) {
			...
			newString = newString.replaceAll("<statskicked>",
					String.valueOf(value));
		}
		if (newString.contains("<statstoolsbroken>")) {
			...
			newString = newString.replaceAll("<statstoolsbroken>",
					String.valueOf(value));
		}
		if (newString.contains("<statseggs>")) {
			...
			newString = newString.replaceAll("<statseggs>",
					String.valueOf(value));
		}
		if (newString.contains("<statsitemscrafted>")) {
			...
			newString = newString.replaceAll("<statsitemscrafted>",
					String.valueOf(value));
		}
		if (newString.contains("<statsate>")) {
			...
			newString = newString.replaceAll("<statsate>",
					String.valueOf(value));
		}
		if (newString.contains("<statsonfire>")) {
			...
			newString = newString.replaceAll("<statsonfire>",
					String.valueOf(value));
		}
		if (newString.contains("<statswords>")) {
			...
			newString = newString.replaceAll("<statswords>",
					String.valueOf(value));
		}
		if (newString.contains("<statscommands>")) {
			...
			newString = newString.replaceAll("<statscommaneds>",
					String.valueOf(value));
		}
		if (newString.contains("<statsvotes>")) {
			...
			newString = newString.replaceAll("<statsvotes>",
					String.valueOf(value));
		}
		if (newString.contains("<statsworldchange>")) {
			...
			newString = newString.replaceAll("<statsworldchange>",
					String.valueOf(value));
		}
		if (newString.contains("<statsbucketfill>")) {
			...
			newString = newString.replaceAll("<statsbucketfill>",
					String.valueOf(value));
		}
		if (newString.contains("<statsbucketempty>")) {
			...
			newString = newString.replaceAll("<statsabucketempty>",
					String.valueOf(value));
		}
		if (newString.contains("<statsbedenter>")) {
			...
			newString = newString.replaceAll("<statsbedenter>",
					String.valueOf(value));
		}
		if (newString.contains("<statsitemdrops>")) {
			...
			newString = newString.replaceAll("<statsitemdrops>",
					String.valueOf(value));
		}
		if (newString.contains("<statsitempickups>")) {
			...
			newString = newString.replaceAll("<statsitempickups>",
					String.valueOf(value));
		}
		if (newString.contains("<statsteleports>")) {
			...
			newString = newString.replaceAll("<statsteleports>",
					String.valueOf(value));
		}
		if (newString.contains("<statsshear>")) {
			...
			newString = newString.replaceAll("<statsshear>",
					String.valueOf(value));
		}
		if (newString.contains("<statsxpgained>")) {
			...
			newString = newString.replaceAll("<statsxpgained>",
					String.valueOf(value));
		}
		if (newString.contains("<statsplaced")) {
			...
			newString = newString.replaceAll("<statsplaced" + s + ">",
					String.valueOf(value));
		}
		if (newString.contains("<statsbroken")) {
			...
			newString = newString.replaceAll("<statsbroken" + s + ">",
					String.valueOf(value));
		...
		if (newString.contains("<statskills")) {
			...
			for (final Object[] vars : blockStat.getAllVariables())
				if ((mob == null)
						|| (EntityType
								.valueOf(vars[0].toString().toUpperCase()) == mob))
					value += blockStat.getValue(vars);

			newString = newString.replaceAll("<statskills" + s + ">",
					String.valueOf(value));
		}
		if (newString.contains("<statsdeaths")) {
			...
			for (final Object[] vars : blockStat.getAllVariables())
				if ((cause == null)
						|| vars[0].toString().toUpperCase()
								.equals(s.toUpperCase()))
					value += blockStat.getValue(vars);

			newString = newString.replaceAll("<statsdeaths" + s + ">",
					String.valueOf(value));
		}
		return newString;
	}
